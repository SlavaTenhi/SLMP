...
namespace SLMPLauncher
{
    public class FuncSettings
    {
        public static void LowPreset()
        {
            ...
            FuncParser.iniWrite(FormMain.iniSkyrimPrefs, "LOD", "fLODFadeOutMultActors", "3.0000");
            FuncParser.iniWrite(FormMain.iniSkyrimPrefs, "LOD", "fLODFadeOutMultObjects", "4.0000");
            FuncParser.iniWrite(FormMain.iniSkyrimPrefs, "LOD", "fLODFadeOutMultItems", "2.0000");
        ...
        public static void MediumPreset()
        {
            ...
            FuncParser.iniWrite(FormMain.iniSkyrimPrefs, "LOD", "fLODFadeOutMultObjects", "6.0000");
            FuncParser.iniWrite(FormMain.iniSkyrimPrefs, "LOD", "fLODFadeOutMultItems", "5.0000");
        ...
        public static void HightPreset()
        {
            ...
            FuncParser.iniWrite(FormMain.iniSkyrimPrefs, "LOD", "fLODFadeOutMultActors", "9.0000");
